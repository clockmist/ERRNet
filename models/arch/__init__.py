...
def wegnet(in_channels, out_channels, **kwargs):
    return WEGNet(in_channels, out_channels, 256, 16, norm=None, res_scale=0.1, pyramid=True, **kwargs)
