"""WEGNet training script.

Wavelet-Enhanced Gradient-guided Network for Single Image Reflection Removal.
Based on ERRNet training pipeline with the following enhancements:
  1. Input-level Haar wavelet decomposition (--inet wegnet)
  2. CBAM residual blocks (built into wegnet architecture)
  3. Deeper encoder: 16 residual blocks (vs. 13 in ERRNet)
  4. Gradient-domain exclusion loss (--lambda_excl 0.2)

Run:  python train_wegnet.py [--debug]
"""
