"""Training script for ERRNet V2 with Transformer backbone + frequency enhancement."""
...
train_dataset = datasets.CEILDataset(
    datadir_syn, read_fns('VOC2012_224_train_png.txt'),
...
eval_dataset_real = datasets.CEILTestDataset(
    join(datadir, 'real20'), size=20, max_long_edge=512)
